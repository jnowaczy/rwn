...
abstract class Action
{
    ...
    protected function respondWithHtml(string $template, array $data = [], int $statusCode = 200): Response
    {
        $view = \Slim\Views\Twig::fromRequest($this->request);
    ...
    protected function respondWithRedirect(
        ...
        return $this->response
            ->withHeader('Location', $this->urlFor($routeName, $data, $queryParams))
            ->withStatus($status);
    }
